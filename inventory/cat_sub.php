 ...
 <div class="container-xxl py-5">
            <div class="container" style="background-color: ghostwhite;">
                 <div class="text-center wow"  >
                    <h1 class="section-title ff-secondary text-center text-primary fw-normal">SUBCATEGORY</h1>
                     <h4 class="mb-1">&nbsp;</h1>
                </div>
...
<button type="button" class="btn btn-secondary btn-sm btn-sm float-end" data-toggle="modal" data-target="#addTable">Add SubCategory</button>
<?php  
 $query = "select inventory_cat_sub.id as id, inventory_cat.name as category, inventory_cat_sub.name as subcategory from inventory_cat_sub, inventory_cat where inventory_cat.id = inventory_cat_sub.cat_id;";
            ...
            <?php foreach($query_run as $a){ ?>
                ...
                <a class="btn btn-danger btn-sm" id="delete" href="<?php echo '#deleteTable'.$a['id']; ?>" data-toggle="modal" data-target="<?php echo '#deleteTable'.$a['id']; ?>">Delete</a>
                                            ...
                                            <div class="modal fade" id="<?php echo 'deleteTable'.$a['id']; ?>" tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'> 
                                                    <form action="codecatSub.php?del=1" method="post">
                                                        
                                                        <div class='modal-dialog' role='document'>
                                                        <div class='modal-content'>
                                                            <div class='modal-header'>
                                                            <h5 class='modal-title' id='exampleModalLabel'>Delete Category (<?php echo $a['subcategory']; ?>)</h5>
                                                            
                                                            </div>
                                                            <input type="hidden" name="id" id="id" value="<?php echo $a['id'];?>">
                                                            
                                                            <div class='modal-body'>Are you sure you want to delete Category (<?php echo $a['subcategory']; ?>)?  
                                                            </div>
                                                ...
                                                <div class="modal fade" id="<?php echo 'editTable'.$a['id']; ?>" tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'> 
                                                    <div class='modal-dialog' role='document'>
                                                        <div class='modal-content'>
                                                            <div class='modal-header'>
                                                                <h5 class='modal-title' id='exampleModalLabel'>Edit Category (<?php echo $a['subcategory']; ?>)</h5>
                                                            </div>
                                                            <form action="codecatSub.php" method="POST">
                                                            <div class="modal-body">
                                                            <input type="hidden" name="id" id="id" value="<?=$a['id']?>">
                                                           
            <div class='modal-body profilefont'>Category: &nbsp; 
        ...
        <div class='modal-body profilefont'>Name: &nbsp;
            <input type="text" name="txtName" value="<?=$a['subcategory']?>" required>
        </div>
...
<table style="width:100%">
    <tr>
    <td style="width:50%"><div class='modal-body profilefont'>
   Category: &nbsp; <select class="form-control select2 form-select" name="txtCategory" required>
    ...
    <td  style="width:50%"> <div class='modal-body profilefont'>Name: &nbsp;

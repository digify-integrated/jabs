 ...
 <div class="container-xxl py-5">
            <div class="container" style="background-color: ghostwhite;">
                 <div class="text-center wow"  >
                    <h1 class="section-title ff-secondary text-center text-primary fw-normal">POS DAILY INVENTORY</h1>
...
<hr>
    ...
    <form action="codeInventoryPos.php" method="POST">  
        <table width="100%">
            <tr>
            <td>
            <?php 
            ...
            <!--<td>Beginning: <br> <input type="number" step=".01" name="txtBeginning" style="width: 100%;" value="<?=( $edit['beginning'] == 0.00) ? '' :  $edit['beginning']?>"></td>-->
            <td>Delivery: <br><input type="number" step=".01" name="txtAdditional" style="width: 100%;" >   </td>
            <td>Out: <br><input type="number step=".01"" name="txtOut" style="width: 100%;" >   </td>
            <!--<td>Transfer:<br> <input type="number" step=".01" name="txtTransfer" style="width: 100%;" value="<?=( $edit['transfer'] == 0.00) ? '' :  $edit['transfer']?>">   </td>-->

...
<button type="button" class="btn btn-secondary btn-sm btn-sm float-end" data-toggle="modal" data-target="#addTable">Add Table</button>
<?php   $query = "select * from tables";
        ...
        if(mysqli_num_rows($query_run) > 0){?>
            ...
            <thead>
                <tr>
                    <th>Name</th>
                    <th style="width:20%;">Seat Count</th>
            ...
            <?php foreach($query_run as $a){ ?>
                ...
                <a class="btn btn-danger btn-sm" id="delete" href="<?php echo '#deleteTable'.$a['id']; ?>" data-toggle="modal" data-target="<?php echo '#deleteTable'.$a['id']; ?>">Delete</a>
                                            ...
                                            <div class="modal fade" id="<?php echo 'deleteTable'.$a['id']; ?>" tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'> 
                                                    <form action="codeTables.php?del=1" method="post">
                                                        
                                                        <div class='modal-dialog' role='document'>
                                                        <div class='modal-content'>
                                                            <div class='modal-header'>
                                                            <h5 class='modal-title' id='exampleModalLabel'>Delete Table (<?php echo $a['name']; ?>)</h5>
                                                            
                                                            </div>
                                                            <input type="hidden" name="id" id="id" value="<?php echo $a['id'];?>">
                                                            
                                                            <div class='modal-body'>Are you sure you want to delete Table (<?php echo $a['name']; ?>)?  
                                                            </div>
                                                ...
                                                <div class="modal fade" id="<?php echo 'editTable'.$a['id']; ?>" tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'> 
                                                    <div class='modal-dialog' role='document'>
                                                        <div class='modal-content'>
                                                            <div class='modal-header'>
                                                                <h5 class='modal-title' id='exampleModalLabel'>Edit Table (<?php echo $a['name']; ?>)</h5>
                                                            </div>
                                                            ...
                                                            <input type="hidden" name="id" id="id" value="<?php echo $a['id'];?>">
                                                                    ...
                                                                    <div class='modal-body profilefont'>Seat/s: &nbsp;
                                                                        <input type="number" name="txtSeat" value="<?php echo $a['count']; ?>">
                                                                    </div>
                                                                    <div class='modal-footer'>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header"><h5 class="modal-title" id="exampleModalLabel">Add Table </h5></div>
                ...
                <div class='modal-body profilefont'>Number of Seat: &nbsp;<input type="number" name="txtSeat" required></div>
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="addTable" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Add Table Details</h5>
      </div>
      <form action="codeTables.php" method="POST">
      <div class="modal-body">
...
<div class='modal-body profilefont'>Seat/s: &nbsp;
    <input type="number" name="txtSeat" required>
</div>
      </div>
      <div class="modal-footer">

...
<div class="container-xxl py-5 bg-dark  mb-5" style="min-height: 100vh;">
           ...
           <div class="container-xxl py-5">
                      <div class="container" style="background-color: ghostwhite; min-height: 100vh;">
                           <div class="text-center wow"  >
                              <h1 class="section-title ff-secondary text-center text-primary fw-normal"> <?php echo strtoupper($row[1]);?>&nbsp; Table <?php echo explode("_", $_SESSION["table_id"])[1]?></h1>
                               <h4 class="mb-1">&nbsp;</h1>
                          </div>
            ...
            <div class="container" style="background-color: ghostwhite;">
                <div class="row g-4">
                <?php if($rowCount > 0){?>
                <div class="col-lg-3 col-sm-6wow" data-wow-delay="0.7s"n onclick="location.href='#ChangeTable';" class="modal fade"  data-toggle="modal" data-target="#ChangeTable">
                        <div class="service-item rounded pt-3" style="background-color: #FEA116;">
                        <div class="p-4" style="padding: 0.3em !important;">
                    ...
                    <div class="modal fade bd-example-modal-lg" id="ChangeTable" tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'> 
                     <form action="codeChangeTable.php" method="POST"  >                
                                ...
                                <div class="col-lg-3 col-sm-6wow" data-wow-delay="0.7s"n onclick="location.href='#PrintBill';" class="modal fade"  data-toggle="modal" data-target="#PrintBill">
                        <div class="service-item rounded pt-3" style="background-color: #FEA116;">
                        <div class="p-4" style="padding: 0.3em !important;">
                     ...
                     <form action="printBill.php" method="POST"  target="print_popup" 
      onsubmit="window.open('about:blank','print_popup','width=1000,height=800');location.reload();">      
                        <!--<form action="codePayOrder.php" method="post">-->
                    ...
                    <!--<div class="col-lg-3 col-sm-6wow"  onclick="window.open('printBill.php?id=<?= $_GET['t'];?>','print_popup','width=1000,height=800');">
                        <div class="service-item rounded pt-3" style="background-color: #FEA116;">
                            <div class="p-4">
                    ...
                    <div class="col-lg-3 col-sm-6wow" data-wow-delay="0.7s"n onclick="location.href='#PayOrder';" class="modal fade"  data-toggle="modal" data-target="#PayOrder">
                        <div class="service-item rounded pt-3" style="background-color: #FEA116;">
                            <div class="p-4" style="padding: 0.3em !important;">
                                <!--<i class="fa fa-3x fa-headset text-primary mb-4"></i>-->
                                <h5>Pay Order</h5>
                     ...
                     <form action="codePayOrder.php" method="POST"  target="print_popup" 
      onsubmit="window.open('about:blank','print_popup','width=1000,height=800');location.reload();">      
                        <!--<form action="codePayOrder.php" method="post">-->
                                  ...
                                  <div class='modal-content'>
                                    ...
                                    <!--<tr>
                                        ...
                                        <td style="text-align: left;"> <input inputmode="numeric" name ="cash_amount" id ="cash_amount" class="text-center form-control-lg mb-2" style=" font-size:3rem; width:100%;background-color: white;border: none;"  min="1"  type="number" placeholder="0"  required>
                                    </tr>-->
                                    <tr>
                    ...
                    <!--<div class="col-lg-3 col-sm-6wow"    onclick="location.href='#VoidOrder';" class="modal fade"  data-toggle="modal" data-target="#VoidOrder">
                        <div class="service-item rounded pt-3" style="background-color: #FEA116;">
                            <div class="p-4" >
                                <h5>VOID</h5>
                            </div>
                       ...
                       <!--VOID MODAL-->
                       <!--<div class="modal fade" id="VoidOrder" tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'> 
                              <form action="codeVoidOrder.php" method="post">  
                                  <div class='modal-dialog' role='document'>
                                  <div class='modal-content'>
                                      <div class='modal-header'>
                                       <h4 class='modal-title' id='exampleModalLabel'>VOID Table Order</h5>
                                      </div>
                                      <input type="hidden" name="id" id="id" value="<?php echo $_SESSION['table_id'];?>">
                                      <div class='modal-body'>Are you sure you want to Void Table Orders?  
                                      </div>
                                      <div class='modal-footer'>

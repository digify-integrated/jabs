                 ...
                 ?><form method="post" action="?action=add&id=<?php echo $row["id"];?>">
                    <div class="product" >
                        ...
                        <input type="submit" name="add" style="width:100%; margin-top: 2px;" class="btn btn-success" value="Add">
                                    ...
                                    <!--<div class="col-lg-3 col-sm-6wow"     onclick="location.href='';">
                                    <div class="service-item rounded pt-3" style="background-color: #FEA116;">
                                    <div class="p-4">
                                        <h5>Table: <?php// echo $p['name']; ?></h5>   
                                     <p>Status/s: PAID OR UNPAID </p>
                                    </div>
                                    </div>
                                    </div>0-->
                                    <?php
                       ...
                       <?php// include 'pos_products.php';?>
                        ...
                        <table class="table table-bordered" style="background-color:white;">
                               ...
                               //     $total=0;
                                    ...
                                    <!--<h1 class="flex-shrink-0 display-5 text-primary mb-0" data-toggle="counter-up"><?php echo number_format($total,2);?></h1>-->
